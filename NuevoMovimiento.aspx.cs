...
namespace PP1
{
    public partial class NuevoMovimiento : System.Web.UI.Page
    {
        ...
        private void LimpiarFormulario()
        {
            ...
            txtFecha.Text = DateTime.Now.ToString("yyyy-MM-dd");
            rblTipoMovimiento.SelectedValue = "Ingreso";

            // Recargamos las categorías para que coincidan con "Ingreso"
            CargarCategorias();

            // Ocultamos el panel de objetivos por si estaba visible
            pnlObjetivos.Visible = false;
        }
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                nuevoMovimiento.IdUsuario = user.IdUsuario;
                nuevoMovimiento.Nombre = txtNombre.Text;
